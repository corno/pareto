...
export const Type_Node = (
    ...
    const string = (value: _out.Initialization<_pi.Deprecated_Source_Location>, delimiter: 'quote' | 'backtick' | 'none'): _out.Initialization<_pi.Deprecated_Source_Location> => {
