...
function test_number_serialization(number: number) {
...
test_number_serialization(1)
test_number_serialization(1.5)
test_number_serialization(-1)
test_number_serialization(-1.5)
test_number_serialization(0)
test_number_serialization(0.234230000)
