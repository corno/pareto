...
export declare namespace T {
    ...
    namespace OptionalGrammar {
        type O = T.Grammar;
    }
    type OptionalGrammar = [false] | [true, T.Grammar];
    namespace ResolveError {
        namespace _ltype {
            type no__such__global__value__type = string;
        }
        type _ltype = ['no such global value type', string];
    }
    type ResolveError = {
        readonly 'type': ['no such global value type', string];
    };
    namespace Value {
