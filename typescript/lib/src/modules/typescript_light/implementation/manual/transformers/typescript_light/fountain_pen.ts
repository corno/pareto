        ...
        switch ($[0]) {
                    ...
                    p_.from.state($.type).decide(($) => {
                        switch ($[0]) {
                            case 'named exports': return p_.ss($, ($) => sh.ph.composed([
                                sh.ph.literal("{ "),
                                sh.ph.indent(
                                    sh.pg.sentences(p_.from.list($.specifiers).map(($) => sh.sentence([
                                        Identifier($.name),
            ...
            case 'switch': return p_.ss($, ($) => sh.pg.sentences([
                sh.sentence([
                    ...
                    sh.ph.indent(sh.pg.sentences(
                        p_.from.list($.clauses).map(($) => sh.sentence([
                            p_.from.state($.type).decide(($) => {
                                switch ($[0]) {
            ...
            case 'type alias declaration': return p_.ss($, ($) => sh.pg.sentences([
                ...
                sh.sentence([
                    ...
                    Identifier($['name']),
                    sh.ph.rich(
                        p_.from.list($['parameters']).map(($) => Identifier($)),
                        sh.ph.nothing(),
                        sh.ph.literal("<"),
                        sh.ph.literal(", "),
                        sh.ph.literal(">"),
...
export const Expression: interface_.Expression = ($, $p) => p_.from.state($).decide(($) => {
    switch ($[0]) {
        ...
        case 'arrow function': return p_.ss($, ($) => sh.ph.composed([
            sh.ph.literal("("),
            sh.ph.rich(
                p_.from.list($.parameters).map(($) => sh.ph.composed([
                    Identifier($.name),
                    p_.from.optional($.type).decide(
                        ($) => sh.ph.composed([
                            sh.ph.literal(": "),
        ...
        case 'call': return p_.ss($, ($) => sh.ph.composed([
            ...
            sh.ph.literal("("),
            sh.ph.indent(
                sh.pg.sentences(p_.from.list($['arguments']).map(($) => sh.sentence([
                    Expression(
                        $,
                        {
                            'object literal needs parentheses': false,
...
export const Type: interface_.Type = ($, $p) => p_.from.state($).decide(($) => {
    switch ($[0]) {
        ...
        case 'function': return p_.ss($, ($) => sh.ph.composed([
            sh.ph.rich(
                p_.from.list($['type parameters']).map(($) => Type($, $p)),
                sh.ph.nothing(),
                sh.ph.literal("<"),
                sh.ph.literal(", "),
                sh.ph.literal(">"),
            ...
            sh.ph.literal("("),
            sh.ph.indent(
                sh.pg.sentences(p_.from.list($['parameters']).map(($) => sh.sentence([
                    Identifier($.name),
                    p_.from.optional($.type).decide(
                        ($) => sh.ph.composed([
                            sh.ph.literal(": "),
        ...
        case 'tuple': return p_.ss($, ($) => sh.ph.composed([
            ...
            sh.ph.literal("["),
            sh.ph.rich(
                p_.from.list($.elements).map(($) => Type($, $p)),
                sh.ph.nothing(),
                sh.ph.nothing(),
                sh.ph.literal(", "),
                sh.ph.nothing(),
        ...
        case 'type reference': return p_.ss($, ($) => sh.ph.composed([
            Identifier($['start']),
            sh.ph.composed(p_.from.list($['tail']).map(($) => sh.ph.composed([
                sh.ph.literal("."),
                Identifier($),
            ]))),
