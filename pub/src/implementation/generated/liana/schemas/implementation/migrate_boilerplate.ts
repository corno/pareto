...
export const Module: t_signatures.Module = ($) => ({
    'type': _p.deprecated_cc($['type'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Module.type_.state => {
            switch ($[0]) {
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                ...
                'type': _p.deprecated_cc($['type'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Module.variable_imports.dictionary.D.entry.type_.state => {
                        switch ($[0]) {
...
export const Module_Set: t_signatures.Module_Set = ($) => ({
    ...
    'dictionary': $.__d_map(($) => ({
        'entry': ({
            ...
            'state': _p.deprecated_cc($, ($): t_out.Module_Set.dictionary.D.entry.state => {
                switch ($[0]) {
    ...
    'sub selection': _p.deprecated_cc($['sub selection'], ($) => ({
        ...
        'list': $.__l_map(($) => ({
            'element': ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Type_Node_Reference.sub_selection.list.L.element.state => {
                    switch ($[0]) {
...
export const Expression: t_signatures.Expression = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Expression.state => {
        switch ($[0]) {
            case 'special': return _p.ss($, ($) => ['special', ({
                'location': ({
                    'file': "implement me",
                    'line': 4.200000000000000e+1,
                    'column': 4.200000000000000e+1,
                }),
                'state': _p.deprecated_cc($, ($): t_out.Expression.state.special.state => {
                    switch ($[0]) {
            ...
            case 'initialize': return _p.ss($, ($) => ['initialize', ({
                'location': ({
                    'file': "implement me",
                    'line': 4.200000000000000e+1,
                    'column': 4.200000000000000e+1,
                }),
                'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state => {
                    switch ($[0]) {
                        case 'boolean': return _p.ss($, ($) => ['boolean', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.boolean_.state => {
                                switch ($[0]) {
                                    case 'literal': return _p.ss($, ($) => ['literal', ({
                                        ...
                                        'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.boolean_.state.literal.state => {
                                            switch ($[0]) {
                        ...
                        case 'component': return _p.ss($, ($) => ['component', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.component.state => {
                                switch ($[0]) {
                        ...
                        case 'dictionary': return _p.ss($, ($) => ['dictionary', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.dictionary.state => {
                                switch ($[0]) {
                                    case 'literal': return _p.ss($, ($) => ['literal', ({
                                        'location': ({
                                            'file': "implement me",
                        ...
                        case 'list': return _p.ss($, ($) => ['list', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.list.state => {
                                switch ($[0]) {
                                    case 'literal': return _p.ss($, ($) => ['literal', ({
                                        'location': ({
                                            'file': "implement me",
                        ...
                        case 'number': return _p.ss($, ($) => ['number', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.number_.state => {
                                switch ($[0]) {
                                    case 'approximation': return _p.ss($, ($) => ['approximation', ({
                                        ...
                                        'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.number_.state.approximation.state => {
                                            switch ($[0]) {
                                                case 'literal': return _p.ss($, ($) => ['literal', $])
                                                default: return _p.au($[0])
                                            }
                                    ...
                                    case 'integer': return _p.ss($, ($) => ['integer', ({
                                        ...
                                        'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.number_.state.integer.state => {
                                            switch ($[0]) {
                                                case 'literal': return _p.ss($, ($) => ['literal', $])
                                                default: return _p.au($[0])
                                            }
                                    ...
                                    case 'natural': return _p.ss($, ($) => ['natural', ({
                                        'location': ({
                                            'file': "implement me",
                                            'line': 4.200000000000000e+1,
                                            'column': 4.200000000000000e+1,
                                        }),
                                        'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.number_.state.natural.state => {
                                            switch ($[0]) {
                                                case 'literal': return _p.ss($, ($) => ['literal', $])
                                                default: return _p.au($[0])
                                            }
                        ...
                        case 'optional': return _p.ss($, ($) => ['optional', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.optional.state => {
                                switch ($[0]) {
                                    case 'literal': return _p.ss($, ($) => ['literal', ({
                                        'location': ({
                                            'file': "implement me",
                                        ...
                                        'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.optional.state.literal.state => {
                                            switch ($[0]) {
                        ...
                        case 'state': return _p.ss($, ($) => ['state', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.state.state => {
                                switch ($[0]) {
                                    case 'literal': return _p.ss($, ($) => ['literal', ({
                        ...
                        case 'text': return _p.ss($, ($) => ['text', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.text.state => {
                                switch ($[0]) {
                                    case 'literal': return _p.ss($, ($) => ['literal', ({
                                        'delimiter': _p.deprecated_cc($['delimiter'], ($) => ({
                                            ...
                                            'state': _p.deprecated_cc($, ($): t_out.Expression.state.initialize.state.text.state.literal.delimiter.state => {
                                                switch ($[0]) {
            ...
            case 'decide': return _p.ss($, ($) => ['decide', ({
                'type': _p.deprecated_cc($['type'], ($) => ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Expression.state.decide.type_.state => {
                        switch ($[0]) {
                            case 'boolean': return _p.ss($, ($) => ['boolean', ({
                                'source': _p.deprecated_cc($['source'], ($) => Selection(
                                    $
                            ...
                            case 'state': return _p.ss($, ($) => ['state', ({
                                ...
                                'type': _p.deprecated_cc($['type'], ($) => ({
                                    ...
                                    'state': _p.deprecated_cc($, ($): t_out.Expression.state.decide.type_.state.state.type_.state => {
                                        switch ($[0]) {
...
export const Abort_Expression: t_signatures.Abort_Expression = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Abort_Expression.state => {
        switch ($[0]) {
...
export const Selection: t_signatures.Selection = ($) => ({
    'start': _p.deprecated_cc($['start'], ($) => ({
        ...
        'state': _p.deprecated_cc($, ($): t_out.Selection.start.state => {
            switch ($[0]) {
                case 'implement me': return _p.ss($, ($) => ['implement me', null])
                ...
                case 'variable': return _p.ss($, ($) => ['variable', ({
                    ...
                    'state': _p.deprecated_cc($, ($): t_out.Selection.start.state.variable.state => {
                        switch ($[0]) {
