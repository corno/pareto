...
export type Acyclic_Lookup<T> = pt.Optional_Value<pt.Lookup<Non_Circular_Result<T>>> //FIXME should this not be optional?
export type _T_Acyclic_Lookup<T> = Acyclic_Lookup<T>

export type Possibly_Circular_Result<T> = pt.Computed_Value<T>

export type Cyclic_Lookup<T> = pt.Optional_Value<pt.Lookup<Possibly_Circular_Result<T>>> //FIXME should this not be optional?
