...
import * as t_signatures from "../../../../../../../interface/generated/liana/schemas/implementation/signatures/resolved/transformers/boilerplate_for_migrate"
                                                        ...
                                                        ($) => ['lookup entry', {
                                                            ...
                                                            'type': _p_change_context(
                                                                ...
                                                                ($) => ({
                                                                    ...
                                                                    'l state': _p.decide.state(
                                                                        $,
                                                                        ($): t_out.Select_Value.l_state.regular.start.l_state.lookup_entry.type_.l_state => {
                                                                            switch ($[0]) {
                                                                                case 'acyclic':
                                                                                    return _p.ss(
                                                                                        $,
