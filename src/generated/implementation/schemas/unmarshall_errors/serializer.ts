...
import * as _i_signatures from "../../../interface/schemas/unmarshall_errors/serializer"


export const Errors: _i_signatures._T_Errors = ($) => ['list', $.map(($) => ['verbose group', _pa.dictionary_literal({
...
export const Location: _i_signatures._T_Location = ($) => ['verbose group', _pa.dictionary_literal({
...
export const Range: _i_signatures._T_Range = ($) => ['verbose group', _pa.dictionary_literal({
...
export const Relative_Location: _i_signatures._T_Relative_Location = ($) => ['verbose group', _pa.dictionary_literal({
