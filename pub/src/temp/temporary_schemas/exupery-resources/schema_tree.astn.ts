...
export const $: g_.Schema_Tree<pd.Source_Location> = st.set({
    ...
    "execute_procedure_executable": x_execute_procedure_executable,
    "execute_query_executable": x_execute_query_executable,
    "execute_query_executable_and_catch": x_execute_query_executable_and_catch,
    "stat": x_stat,
})