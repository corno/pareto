...
export const Module: t_signatures.Module = ($) => ({
    ...
    'type imports': _p.deprecated_cc(
        $['type imports'], 
        ($) => v_interface.Imports(
            $
        )
    ),
    'variable imports': _p.deprecated_cc(
        $['variable imports'], 
        ($) => ({
            'location': ({
                'file': "implement me",
                                            ...
                                            case 'ancestor':
                                                return _p.ss(
                                                    ...
                                                    ($) => ['ancestor', ({
                                                        ...
                                                        'number of steps': _p.deprecated_cc(
                                                            $['number of steps'], 
                                                            ($) => $
                                                        ),
                                                    })]
            ...
            'dictionary': $.__d_map(
                ($,id) => ({
                    'entry': ({
                        ...
                        'temp has abort': _p.deprecated_cc(
                            $['temp has abort'], 
                            ($) => $
                        ),
                        'temp has lookups': _p.deprecated_cc(
                            $['temp has lookups'], 
                            ($) => $
                        ),
                        'temp has parameters': _p.deprecated_cc(
                            $['temp has parameters'], 
                            ($) => $
                        ),
                    }),
...
export const Type_Node_Reference: t_signatures.Type_Node_Reference = ($) => ({
    ...
    'sub selection': _p.deprecated_cc(
        $['sub selection'], 
        ($) => ({
            'location': ({
                'file': "implement me",
            ...
            'list': $.__l_map(
                ($) => ({
                    'item': ({
                        ...
                        'state': _p.decide.state(
                            $, 
                            ($): t_out.Type_Node_Reference.sub_selection.list.L.item.state => {
                                switch ($[0]) {
                                    case 'dictionary':
                                        return _p.ss(
                                            $, 
                        ...
                        case 'entry':
                            return _p.ss(
                                ...
                                ($) => ['entry', ({
                                    ...
                                    'abort handler': _p.deprecated_cc(
                                        $['abort handler'], 
                                        ($) => Abort_Expression(
                                            $
                                        )
                        ...
                        case 'variable':
                            return _p.ss(
                                ...
                                ($) => ['variable', ({
                                    ...
                                    'state': _p.decide.state(
                                        $, 
                                        ($): t_out.Selection.start.state.variable.state => {
                                            switch ($[0]) {
                                                case 'local':
                                                    return _p.ss(
                                                        $, 
                                                ...
                                                case 'boolean':
                                                    return _p.ss(
                                                        ...
                                                        ($) => ['boolean', ({
                                                            ...
                                                            'temp resulting node': _p.deprecated_cc(
                                                                $['temp resulting node'], 
                                                                ($) => $.__o_map(
                                                                    ($) => Type_Node_Reference(
                                                                        $
                                                ...
                                                case 'optional':
                                                    return _p.ss(
                                                        ...
                                                        ($) => ['optional', ({
                                                            ...
                                                            'if not set': _p.deprecated_cc(
                                                                $['if not set'], 
                                                                ($) => Expression(
                                                                    $
                                                                )
                                                            ),
                                                            'if set': _p.deprecated_cc(
                                                                $['if set'], 
                                                                ($) => Expression(
                                                                    $
                                                                )
                                        ...
                                        case 'component':
                                            return _p.ss(
                                                ...
                                                ($) => ['component', ({
                                                    ...
                                                    'state': _p.decide.state(
                                                        $, 
                                                        ($): t_out.Expression.state.initialize.state.component.state => {
                                                            switch ($[0]) {
                                                                case 'call':
                                                                    return _p.ss(
                                                                        $, 
                                                                ...
                                                                case 'map':
                                                                    return _p.ss(
                                                                        ...
                                                                        ($) => ['map', ({
                                                                            ...
                                                                            'entry handler': _p.deprecated_cc(
                                                                                $['entry handler'], 
                                                                                ($) => Expression(
                                                                                    $
                                                                                )
                                        ...
                                        case 'block':
                                            return _p.ss(
                                                ...
                                                ($) => ['block', ({
                                                    ...
                                                    'temp ordered variables': _p.deprecated_cc(
