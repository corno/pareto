...
export interface IStream<DataType> extends IInStream<DataType> {
    mapData<NewDataType>(onData: (data: DataType) => NewDataType): IStream<NewDataType>
    ...
    reduce<ResultType>(initialValue: ResultType, onData: (previousValue: ResultType, data: DataType) => ResultType): ISafePromise<ResultType>
