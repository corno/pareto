import * as _pi from "pareto-core-interface"
    ...
    export type _T_Node_Resolver<M_Source> = _i_core._T_State_Group<M_Source, 
        ...
        | readonly ['component', {
            ...
            readonly 'arguments': _pi.Optional_Value<{
                readonly 'values': _pi.Optional_Value<_i_core._T_Dictionary<M_Source, _i_core._T_State_Group<M_Source, 
                ...
                >>>
                readonly 'lookups': _pi.Optional_Value<_i_core._T_Dictionary<M_Source, _i_core._T_State_Group<M_Source, 
        ...
        | readonly ['dictionary', {
            ...
            readonly 'resolver': _T_Node_Resolver<M_Source>
            readonly 'benchmark': _pi.Optional_Value<_T_Benchmark<M_Source>>
        }]
        ...
        | readonly ['list', {
            ...
            readonly 'resolver': _T_Node_Resolver<M_Source>
            readonly 'result': _pi.Optional_Value<_T_Node_Resolver_List_Result<M_Source>>
        }]
        | readonly ['nothing', null]
        ...
        export namespace precision {
            ...
            export namespace SG {
                ...
                export namespace exact {
                    ...
                    export type decimal_separator_offset<M_Source> = _pi.Optional_Value<number>
    ...
    export namespace _T_Group {
        ...
        export namespace D {
            ...
            export type description<M_Source> = _pi.Optional_Value<string>
    ...
    export namespace _T_Node_Resolver {
        ...
        export namespace SG {
            ...
            export namespace component {
                ...
                export namespace _arguments {
                    ...
                    export namespace O {
                        ...
                        export type values<M_Source> = _pi.Optional_Value<_i_core._T_Dictionary<M_Source, _i_core._T_State_Group<M_Source, 
                            | readonly ['optional', _T_Optional_Value_Initialization<M_Source>]
                            | readonly ['required', _T_Guaranteed_Value_Selection<M_Source>]
                            | readonly ['parameter', _i_core._T_Reference_To_Normal_Dictionary_Entry<M_Source, _T_Signature_Parameters.values.D<M_Source>>]
                        >>>
                        ...
                        export type lookups<M_Source> = _pi.Optional_Value<_i_core._T_Dictionary<M_Source, _i_core._T_State_Group<M_Source, 
                            | readonly ['empty stack', null]
                            | readonly ['not set', null]
                            | readonly ['selection', _T_Lookup_Selection<M_Source>]
                            | readonly ['stack', {
                ...
                export type _arguments<M_Source> = _pi.Optional_Value<{
                    readonly 'values': _pi.Optional_Value<_i_core._T_Dictionary<M_Source, _i_core._T_State_Group<M_Source, 
                        | readonly ['optional', _T_Optional_Value_Initialization<M_Source>]
                        | readonly ['required', _T_Guaranteed_Value_Selection<M_Source>]
                        | readonly ['parameter', _i_core._T_Reference_To_Normal_Dictionary_Entry<M_Source, _T_Signature_Parameters.values.D<M_Source>>]
            ...
            export namespace dictionary {
                ...
                export type benchmark<M_Source> = _pi.Optional_Value<_T_Benchmark<M_Source>>
            }
            export type dictionary<M_Source> = {
                readonly 'definition': _i_core._T_Derived_Reference<M_Source, _T_Dictionary<M_Source>>
                readonly 'resolver': _T_Node_Resolver<M_Source>
            ...
            export namespace list {
                ...
                export type result<M_Source> = _pi.Optional_Value<_T_Node_Resolver_List_Result<M_Source>>
            }
            export type list<M_Source> = {
                readonly 'definition': _i_core._T_Derived_Reference<M_Source, _T_Type_Node.SG.list<M_Source>>
                readonly 'resolver': _T_Node_Resolver<M_Source>
