    ...
    'dictionary': $.__d_map(($) => ({
        'entry': ({
            'type': _p.deprecated_cc($['type'], ($) => ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Imports.dictionary.D.entry.type_.state => {
                    switch ($[0]) {
    ...
    'types': _p.deprecated_cc($['types'], ($) => ({
        ...
        'dictionary': $.__d_map(($) => ({
            'entry': ({
                ...
                'state': _p.deprecated_cc($, ($): t_out.Module.types.dictionary.D.entry.state => {
                    switch ($[0]) {
                        ...
                        case 'algorithm': return _p.ss($, ($) => ['algorithm', ({
                            ...
                            'type': _p.deprecated_cc($['type'], ($) => ({
                                ...
                                'state': _p.deprecated_cc($, ($): t_out.Module.types.dictionary.D.entry.state.algorithm.type_.state => {
                                    switch ($[0]) {
                                            ...
                                            'lookups': _p.deprecated_cc($['lookups'], ($) => $.__o_map(($) => ({
                                                ...
                                                'dictionary': $.__d_map(($) => ({
                                                    'entry': ({
                                                        ...
                                                        'state': _p.deprecated_cc($, ($): t_out.Module.types.dictionary.D.entry.state.algorithm.type_.state.refiner.lookups.O.dictionary.D.entry.state => {
                                                            switch ($[0]) {
...
export const Type_Reference: t_signatures.Type_Reference = ($) => ({
    ...
    'state': _p.deprecated_cc($, ($): t_out.Type_Reference.state => {
        switch ($[0]) {
                ...
                'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.number_.state => {
                    switch ($[0]) {
                        case 'exact': return _p.ss($, ($) => ['exact', ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.number_.state.exact.state => {
                                switch ($[0]) {
                ...
                'sub selection': _p.deprecated_cc($['sub selection'], ($) => ({
                    ...
                    'list': $.__l_map(($) => ({
                        'element': ({
                            ...
                            'state': _p.deprecated_cc($, ($): t_out.Type_Node.state.reference.sub_selection.list.L.element.state => {
                                switch ($[0]) {
